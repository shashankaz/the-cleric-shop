  ...
  return (
    <div className="flex items-center justify-evenly flex-col uppercase h-[80vh]">
      ...
      <div className="flex flex-col items-center justify-center">
        <h3 className="md:text-2xl text-lg">Get notified when it's ready</h3>
        <div className="flex items-center justify-center bg-[#444] md:w-[450px] w-[300px] md:h-[42px] h-[32px] rounded-[50px] mt-[10px]">
          <input
            className="md:w-[300px] w-[220px] mx-6 border-none outline-none bg-[#444] text-white md:text-[15px] text-[13px]"
            type="email"
          ...
          <button
            type="submit"
            className="md:w-[150px] w-[140px] uppercase bg-black text-white h-full rounded-[50px] md:text-[15px] text-[13px]"
            onClick={submit}
          >
            Notify me
          </button>
